            ...
            <div className="about-content">
                <div className="tablet">
                    <div className="tablet-text">
                        ...
                        currently developing more skills using ReactJS and TypeScript.
                        Continuously focused on career growth and expanding experiences by taking head-on complex tasks while also
                        enjoying the satisfaction of implementing design into reality.
                        </p>
